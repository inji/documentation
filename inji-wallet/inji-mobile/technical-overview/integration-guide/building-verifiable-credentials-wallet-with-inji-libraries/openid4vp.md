...
| **`getMatchingCredentials()`**   | _(DCQL Helper)_ Evaluates DCQL queries against your wallet's credentials to determine which satisfy the verifier's requirements.           |
