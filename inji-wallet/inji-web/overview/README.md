...
* **IETF SD-JWT and Selective Disclosure**&#x20;
...
* **OpenID4VP Credential Presentation for JSON-LD VC Format and IETF SD-JWT VC Format**
  * Enables users to present W3C JSON-LD and IETF SD-JWT Verifiable Credentials directly to verifiers using OpenID4VP flows.
...
* ISO/IEC 18013-5 mDoc/mDL Support
* **DPoP:** _Demonstrating Proof-of-Possession Support_
...
<i class="fa-discourse">:discourse:</i> Community Forum:  [Inji community forum](https://community.mosip.io/c/inji/16)&#x20;
